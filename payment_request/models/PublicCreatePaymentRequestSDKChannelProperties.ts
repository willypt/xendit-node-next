 ...
 * 
 * @export
 * @interface PublicCreatePaymentRequestSDKChannelProperties
 */
export interface PublicCreatePaymentRequestSDKChannelProperties {
    /**
     * URL where the end-customer is redirected if the authorization is successful
     * @type {string}
     * @memberof PublicCreatePaymentRequestSDKChannelProperties
     */
     ...
     * @memberof PublicCreatePaymentRequestSDKChannelProperties
     */
    cardonfileType?: PublicCreatePaymentRequestSDKChannelPropertiesCardonfileTypeEnum;
    /**
 ...
 * @export
 */
export const PublicCreatePaymentRequestSDKChannelPropertiesCardonfileTypeEnum = {
    MerchantUnscheduled: 'MERCHANT_UNSCHEDULED',
    CustomerUnscheduled: 'CUSTOMER_UNSCHEDULED',
    Recurring: 'RECURRING'
} as const;
export type PublicCreatePaymentRequestSDKChannelPropertiesCardonfileTypeEnum = typeof PublicCreatePaymentRequestSDKChannelPropertiesCardonfileTypeEnum[keyof typeof PublicCreatePaymentRequestSDKChannelPropertiesCardonfileTypeEnum];


/**
 * Check if a given object implements the PublicCreatePaymentRequestSDKChannelProperties interface.
 */
export function instanceOfPublicCreatePaymentRequestSDKChannelProperties(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PublicCreatePaymentRequestSDKChannelPropertiesFromJSON(json: any): PublicCreatePaymentRequestSDKChannelProperties {
    return PublicCreatePaymentRequestSDKChannelPropertiesFromJSONTyped(json, false);
}

export function PublicCreatePaymentRequestSDKChannelPropertiesFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicCreatePaymentRequestSDKChannelProperties {
...
export function PublicCreatePaymentRequestSDKChannelPropertiesToJSON(value?: PublicCreatePaymentRequestSDKChannelProperties | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
