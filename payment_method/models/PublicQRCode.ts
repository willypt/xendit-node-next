...
/**
 * Check if a given object implements the PublicQRCode interface.
 */
export function instanceOfPublicQRCode(value: object): boolean {
    let isInstance = true;

    return isInstance;
}

export function PublicQRCodeFromJSON(json: any): PublicQRCode {
    return PublicQRCodeFromJSONTyped(json, false);
}

export function PublicQRCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PublicQRCode {
...
export function PublicQRCodeToJSON(value?: PublicQRCode | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
