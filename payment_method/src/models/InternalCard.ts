...
/**
 * Check if a given object implements the InternalCard interface.
 */
export function instanceOfInternalCard(value: object): boolean {
    let isInstance = true;
...
export function InternalCardFromJSON(json: any): InternalCard {
    return InternalCardFromJSONTyped(json, false);
}

export function InternalCardFromJSONTyped(json: any, ignoreDiscriminator: boolean): InternalCard {
...
export function InternalCardToJSON(value?: InternalCard | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
